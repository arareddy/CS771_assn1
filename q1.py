...
tr_data = load_svmlight_file("assn1data/train.dat");

Xtr = tr_data[0].toarray(); # Converts sparse matrices to dense
Ytr = tr_data[1]; # The training labels, these are either 1,2 or 3

test_data = load_svmlight_file("assn1data/test.dat");

Xtest = test_data[0].toarray(); #Coordinates of the test data 
Ytest = test_data[1]; # The test labels
...
for k in k_list:
    ...
    with open("q1_results.txt", "a") as myfile:
